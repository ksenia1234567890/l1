...
1. Git clone ````https://github.com/ksenia1234567890/l1````
...
* Сначала надо включить режим разработчика на вашем мобильном устройсте, как это сделать можно 
...
Запустив приложение вам будет доступна единственная кнопка button1, нажмите её чтобы передать 
параметр заданный внутри кнопки.
